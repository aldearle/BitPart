...
/*
 * Multi threaded V6.
 * Like V5 but copies rows of phase 2 to see if that helps with locality in NUMA.
 * This does not work and is very expensive:
 *     This version:
 *              results	129547
 *              time	62.692
 *              find_exclusions_time	0.0
 *              do_exclusions_time	62.639
 *              partitions excluded	25.504
 *     V5:
 *              results	129547
 *              time	24.882
 *              find_exclusions_time	0.0
 *              do_exclusions_time	24.835
 *              partitions excluded	25.504
 *
 * Hypothesis: Solution is to horizontally partition data rep into blocks
 * Question: how to get processor affinity with the blocks?
 * Theory: Create objects with encapsulated threads that hold horizontal state - MTV7
 *
 */

public class MainRunnerFileMTV6 extends MainRunnerFile {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        int degree_of_parallelism = 1; //Runtime.getRuntime().availableProcessors();
        ...
        System.out.println("codebase\t" + "MainRunnerFileMTV6" );
            ...
            block_result_futures.add(executor.submit(() -> {
                ...
                for (int long_in_block = 0; long_in_block < block_results.length; long_in_block++) { // iterate over the rows (of longs) in the block
                    ...
                    if( source_row_index < datarep.length ) { // might be over due to long rounding
                        ...
                        long[] long_row = datarep[source_row_index].clone();
